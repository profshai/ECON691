...
# Save the "States" dataframe
save(States, file = "./Build/Output/States.Rda") 
...
#Calculating percentage changes between 2016 and 2019 
merged = merged %>%
...
# Save CENSUS.3 data
save.image(file="./Build/Output/CENSUS.3.RData")
